  ...
  <b-container fluid>
    <div>
      <b-badge
        ...
        :key="index"
        @click="setLevelParams(level.key, 'level')"
      >{{ level.value }}</b-badge>
    </div>
    <div class="box">
      <b-badge
        ...
        :key="index"
        @click="setLevelParams(type.key, 'type')"
      >{{ type.value }}</b-badge>
    </div>
    <div class="box">
      <b-badge
        ...
        :key="index"
        @click="setLevelParams(ability.key, 'ability')"
      >{{ ability.value }}</b-badge>
    </div>
    <div class="box">
      <b-badge
        variant="info"
        ...
        :key="index"
        @click="setLevelParams(clas.key, 'class')"
      >{{ clas.value }}</b-badge>
    </div>
    <div class="box">
...
export default {
  ...
  methods: {
    ...
    setAttribute(attribute, addition) {
      ...
      let attributeArray = this.attributes
        .filter(item => item.value === attribute)
        .shift();
